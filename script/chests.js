    ...
    },
    {
        ...
        chestlist: {
            ...
            'Deku Salesman Grotto': { isAvailable: function () {
                return (hasBoom() || (items.Hammer && (canPlay(items.SariasSong) || canPlay(items.MinuetofForest)))); }, },
...
var chests = [
    ...
    },
    {
        ...
        y: "23.0%",
        isAvailable: function() {
            if ((canPlay(items.EponasSong) || items.Hookshot >= 2) && (items.HoverBoots || items.Hookshot >= 2 || ( items.Ocarina && items.Hookshot >= 1))) {
                return "available";
            }
            return "unavailable";
        },
