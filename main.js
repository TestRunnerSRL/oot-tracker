...
function isLensNeeded(lensLogic, location) {
    switch (lensLogic){
        case 'Everywhere':
            return true;
        case 'Someplace':
...
function isPastWasteland(loc){
    if (loc.valueAsString == 'Spirit Temple' || 'Haunted Wasteland Chest' || 'Requiem of Spirit' || 'Desert Colossus Fairy'){
